...
- Fixed: Reflected XSS vulnerability in the social share meta tag when embedding PDFs (security fix).
- Fixed: SmugMug direct image and deep-gallery URLs failing to embed.
- Improved: Analytics content counting no longer runs slow full-table scans on very large sites.
- Few minor bug fixes and improvements.

= [4.6.5] – 2026-09-01 =
- Fixed: Author and byline links from other plugins appearing oversized on pages with no embed.
- Fixed: Analytics preventing Cloudflare and other CDNs from caching any page on the site.
- Few minor bug fixes and improvements.

= [4.6.4] – 2026-08-18 =
- Fixed: YouTube live URLs now show the correct upcoming stream or latest video.
- Fixed: Block editor crash and incorrect block styles inside the editor canvas.
- Fixed: Google Reviews user permission and access control issues.
- Fixed: Google Reviews schema and endpoint security vulnerabilities.
- Improved: Google Reviews place search authentication and reliability.
- Few minor bug fixes and improvements.
